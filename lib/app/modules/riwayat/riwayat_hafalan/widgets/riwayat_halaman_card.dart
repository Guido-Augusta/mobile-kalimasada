...
class RiwayatHalamanCard extends StatelessWidget {
  final model_halaman.Datum datum;
  final model_ayat.Santri santri;
  final String filterStatus;
  final String Function(String?) getStatusText;
  final Function(model_halaman.Datum datum, model_ayat.Santri santri, String subtitle) onDelete;

  const RiwayatHalamanCard({
    super.key,
    required this.datum,
  ...
  Widget build(BuildContext context) {
    final String title = 'Juz ${datum.juz}';
    final String subtitle = datum.surah.map((e) => e.namaLatin).join(', ');
    final String rangeLabel = 'Hal ${datum.rangeHalaman?.awal ?? 0} - ${datum.rangeHalaman?.akhir ?? 0}';
