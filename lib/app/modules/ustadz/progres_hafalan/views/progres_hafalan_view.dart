          ...
          return NotificationListener<UserScrollNotification>(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                else if ((controller.filterMode.value == 'surah' &&
                ...
                else if (controller.filterMode.value == 'juz' &&
                    controller.searchQuery.value.isNotEmpty &&
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        ...
                        childCount: controller.searchQuery.value.isEmpty
                            ? controller.progresHafalanJuz.length
                            : controller.filteredJuzList.length,
                      ),
                    ),
                  ),
              ],
      ...
      child: AnimatedContainer(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: isActive ? Colors.white : Colors.deepPurple[400],
          ),
        ),
      ),
    );
